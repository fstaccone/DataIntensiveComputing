...
public class TopTen {
	...
	protected void cleanup(Context context) throws IOException, InterruptedException {
		...
		context.write(NullWritable.get(), t); //EDIT null	    }
	}
    }
...
/* After all the values have been iterated over, the values of Id and Reputaion contained in 
the TreeMap should be stored in the table topten in HBase. We use the columns info:rep and 
info:id to store them.
*/
	...
	Job job = Job.getInstance(conf, "TopTen"); // assign the job, with a name
	job.setJarByClass(TopTen.class); 
	job.setMapperClass(TopTenMapper.class);  //assign the classes
